...
document.getElementById("share").href = "whatsapp://send?text=" + "सवतंत्रता दिवस के अवसर पर " + "*" + name1 + "*" + " की तरफ से आपको wish किया जाता है" + "%0A" + "क्लिक करे और सन्देश देखे👇👇👇👇" + "%0A" + shareUrl + "?by=" + name1.replace("#", "").replace(/ /g, "_");
