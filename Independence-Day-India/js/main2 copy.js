...
document.getElementById("share1").href = "whatsapp://send?text=" + "स्वतंत्रता दिवस के शुभ अवसर " + "*" + name1 + "*" + " ने आपको स्वतंत्रता दिवस की बधाई दी है।" + "%0A" + "आप भी नीचे लिंक पर क्लिक करके दुसरो को बधाई दे।👇👇👇👇" + "%0A" + shareUrl + "?by=" + name1.replace("#", "").replace(/ /g, "_");
document.getElementById("share2").href = "https://telegram.me/share/url?url=" + shareUrl + "?by=" +name1.replace("#", "").replace(/ /g, "_")+"&text="+ "स्वतंत्रता दिवस के शुभ अवसर " + name1 + " ने आपको स्वतंत्रता दिवस की बधाई दी है।" + "%0A" + "आप भी ऊपर लिंक पर क्लिक करके दुसरो को बधाई दे।👆👆👆👆";
document.getElementById("share3").href = "https://twitter.com/intent/tweet?text=" + "स्वतंत्रता दिवस के शुभ अवसर " + name1 + " ने आपको स्वतंत्रता दिवस की बधाई दी है।" + "%0A" + "आप भी नीचे लिंक पर क्लिक करके दुसरो को बधाई दे। 👇👇👇👇" + "%0A" + shareUrl + "?by=" + name1.replace("#", "").replace(/ /g, "_");
